...
17. On your ID review branch in VSC, save, stage, commit and push your changes to GitHub by using the guide [Send (push) files]({{site.baseurl}}/branches/push-files.html).
