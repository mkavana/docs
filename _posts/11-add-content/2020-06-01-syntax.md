...
Start with the [Important considerations for creating content in markdown](#markdown-considerations), and then choose a markdown element from the list of [Markdown elements in this guide](#markdown-element-list).

{% include prerequisites.html %}

## Markdown elements in this guide {#markdown-element-list}

- [Important considerations for creating content in markdown](#markdown-considerations)
- [Generate markdown elements in VSC](#markdown-elements)
- [Headings](#markdown-headings)
- [Text styles](#markdown-text)
- [Bulleted lists](#markdown-bullet-list)
- [Numbered lists](#markdown-number-list)
- [Tables](#markdown-tables)
- [Images](#markdown-images)
- [Hyperlinks](#markdown-links)
- [Code blocks](#markdown-code-blocks)
- [Smart apostrophes and quotation marks](#markdown-smart-chars)
...
![Examples of markdown headings at different levels](../assets/images/11-add-content/syntax/syntax-002.png)
...
![Markdown bold and italic text style examples](../assets/images/11-add-content/syntax/syntax-003.png)
...
## Bulleted lists {#markdown-bullet-lists}
...
![Markdown bullet list example](../assets/images/11-add-content/syntax/syntax-004.png)
...
![Markdown two-level bullet list example](../assets/images/11-add-content/syntax/syntax-005.png)
...
![Markdown multilevel bullet list example](../assets/images/11-add-content/syntax/syntax-006.png)
...
![Markdown numbered list example](../assets/images/11-add-content/syntax/syntax-007.png)
...
![Markdown two-level numbered list example](../assets/images/11-add-content/syntax/syntax-008.png)
...
![Markdown multilevel numbered list example](../assets/images/11-add-content/syntax/syntax-009.png)
...
![Markdown table with a header row example](../assets/images/11-add-content/syntax/syntax-010.png)
...
![Markdown table without a header row example](../assets/images/11-add-content/syntax/syntax-011.png)
...
## Graphics and images {#markdown-images}
...
![Example of how an in-line image renders in markdown](../assets/images/11-add-content/syntax/syntax-012.png) Paragraph text.
...
![Example of how a stand alone image renders in markdown](../assets/images/11-add-content/syntax/syntax-013.png)
...
![Markdown code block example](../assets/images/11-add-content/syntax/syntax-014.png)
